          ...
          <div class="grid grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div class="flex flex-col items-center text-center">
                ...
                <div class="text-3xl font-bold text-rose-700 mb-2" data-count="1500">1,500+</div>
            ...
            <div class="bg-white rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div class="flex flex-col items-center text-center">
                ...
                <div class="text-3xl font-bold text-rose-700 mb-2" data-count="250">250+</div>
                <div class="text-gray-600 text-sm font-medium">Families Empowered</div>
              </div>
            </div>
            ...
            <div class="bg-white rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div class="flex flex-col items-center text-center">
                ...
                <div class="text-3xl font-bold text-rose-700 mb-2" data-count="45">45+</div>
